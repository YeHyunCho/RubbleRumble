...
public class CleanerBase : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Can") || other.CompareTag("Box") || other.CompareTag("Dust") || other.CompareTag("UnfoldedBox") || other.CompareTag("Water")) // ������ �±� �� Trash�� ���Ͻ��ѵ��ɵ�?
        {
