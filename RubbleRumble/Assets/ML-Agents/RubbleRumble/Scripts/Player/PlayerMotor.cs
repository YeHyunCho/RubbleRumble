...
public class PlayerMotor : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (playerStamina == null)
        {
            ...
            Debug.LogWarning("PlayerMotor: PlayerStamina 컴포넌트를 찾을 수 없습니다! 대시 기능이 작동하지 않습니다.");
        }
        ...
        if (dustEffect == null)
        {
            ...
            Debug.LogWarning("PlayerMotor: 먼지 효과(Dust Effect) 파티클 시스템이 설정되지 않았습니다. 효과가 나타나지 않을 수 있습니다.");
        }
